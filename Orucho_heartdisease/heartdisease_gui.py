...
def takeInput():
    ...
    if final_Result[0] == 1:
        ...
        label2 = tkinter.Label(substituteWindow, text="PLEASE VISIT YOUR NEAREST CARDIOLOGIST AT THE EARLIEST", font=('Impact', -20), fg='red')
        label2.grid(row=1, column=1, columnspan=6)
        label3 = tkinter.Label(substituteWindow, text = "The Aga Khan University Hospital, Kenya 0800-590-700", font=('Times', -15))
        label3.grid(row=3, column = 2)
        label4 = tkinter.Label(substituteWindow, text = "Kenya Heart Center", font=('Times', -15))
        label4.grid(row=4, column = 2)
        label4 = tkinter.Label(substituteWindow, text = "Kenyatta National Hospital 020-800-900", font=('Times', -15))
        ...
        label2 = tkinter.Label(substituteWindow, text="Do Not Forget to Exercise Daily And Eat Healthy Food. ", font=('Impact', -20), fg='green')
        label2.grid(row=3, column=1, columnspan=6)      
        
    substituteWindow.mainloop()
        

heart = pd.read_csv("/home/orucho/Desktop/Orucho_heartdisease/Dataset.csv")
...
#knn is the model used in my system
...
ageFrame = tkinter.LabelFrame(mainWindow, text="Age(Years)")
